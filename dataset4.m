...
for file_no=1:L
    ...
    for act=1:6
        ...
        if act==1
            a=Act_01_ch_1'; b=Act_01_ch_2'; c=Act_01_ch_3'; d=Act_01_ch_4';   end
        if act==2
            a=Act_02_ch_1'; b=Act_02_ch_2'; c=Act_02_ch_3'; d=Act_02_ch_4'; end
        if act==3
            a=Act_03_ch_1'; b=Act_03_ch_2'; c=Act_03_ch_3'; d=Act_03_ch_4'; end
        if act==4
            a=Act_04_ch_1'; b=Act_04_ch_2'; c=Act_04_ch_3'; d=Act_04_ch_4';  end
        if act==5
            a=Act_05_ch_1'; b=Act_05_ch_2'; c=Act_05_ch_3'; d=Act_05_ch_4';  end
        if act==6
            a=Act_06_ch_1'; b=Act_06_ch_2'; c=Act_06_ch_3'; d=Act_06_ch_4';   end
        ...
        for trial=1:6
            ...
            for seg_count=1:15
                ...
                feat_seg=[feat_seg features_1 features_2 features_3 features_4 ];
            end
...
csvwrite('C:\Users\Dell\OneDrive\Desktop\himi\btp\dataverse_files\segmentation\dataset4.csv', [x;data]);
